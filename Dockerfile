...
&& unzip IfcConvert-v0.6.0-517b819-linux64.zip -d /usr/local/bin && rm ./IfcConvert-v0.6.0-517b819-linux64.zip
...
&& ln -s /COLLADA2GLTF/COLLADA2GLTF-bin /usr/local/bin/COLLADA2GLTF-bin && rm ./COLLADA2GLTF-v2.1.5-linux.zip
